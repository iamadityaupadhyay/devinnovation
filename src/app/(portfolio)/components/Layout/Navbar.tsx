...
const Navbar: React.FC = ({contact, services}: any) => {
 ...
 const industries = [
    ...
    },
    {
      ...
      imageUrl: "https://images.unsplash.com/photo-1559526324-4b87b5e36e44?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlcurtains=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80",
    ...
    },
    {
      name: "Sports",
      href: "/service/sports",
      imageUrl: "https://images.unsplash.com/photo-1461896836934-7a61a109cc05?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80",
                    ...
                    {item.isServicesDropdown ? (
                      <div>
                        ...
                        <div className="grid grid-cols-5 gap-4">
                          {servicesData.map((service: { name: any; bgColor: any; image: string }, serviceIndex: any) => (
                            <a
                              onClick={() => setActiveDropdown(null)}
                              key={serviceIndex}
                  ...
                  <div className="pl-4 pb-2">
                    {item.isServicesDropdown ? (
                      <div className="grid grid-cols-2 gap-2 py-2">
                        {servicesData.map((service: { name: any; image: string }, serviceIndex: any) => (
                          <a
                            key={serviceIndex}
                            href={`/service/${String(service.name ?? "").toLowerCase().replace(/\s+/g, "-")}`}
                            onClick={() => {
