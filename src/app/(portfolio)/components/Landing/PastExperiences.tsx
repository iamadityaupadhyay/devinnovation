...
export default function PastExperiences() {
  ...
  >
    <div className="inline-flex items-center justify-center  text-gray-800 px-4 py-2 rounded-md text-base font-medium hover:bg-orange-600 hover:text-white transition-colors mt-2">
