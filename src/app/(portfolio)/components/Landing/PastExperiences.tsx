...
export default function PastExperiences() {
  ...
  <Link
    ...
    className="w-full   text-lg p-4 text-center"
  >
    <div className="inline-flex items-center justify-center  text-gray-800 px-4 py-2 rounded-md text-lg font-medium hover:bg-orange-600 hover:text-white transition-colors mt-2">
  ...
  <a
    ...
    className=" inline-flex items-center justify-center px-6 py-2 rounded-md bg-green-500 text-white font-medium text-lg shadow-md transition-all duration-300 hover:bg-green-600 focus:outline-none focus:ring-2 focus:ring-green-400 "
