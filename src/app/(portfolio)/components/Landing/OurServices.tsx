    ...
    >
      ...
      <div
        className={`
          ...
          ${isHovered ? "shadow-2xl bg-white/80" : "shadow-lg"}
        `}
        style={{
      ...
      >
        {/* Icon and More Info */}
        <div className="relative z-10 flex items-center justify-between mb-6 transition-all duration-300 scale-105">
          <div>
            <img src={service.icon ? service.icon : "hello.png"} className="w-14 rounded-full" />
          </div>
          <div
          ...
          >
            <Link
              href={`/service/${service.title.replaceAll(" ", "-").toLowerCase()}`}
              className="bg-orange-500 hover:bg-orange-600 text-white px-4 py-1.5 rounded-full text-sm font-medium transition-all duration-300 flex items-center justify-center gap-2 group"
            >
              More Info
        ...
        <div className="relative z-10">
          <h3
            className={`font-bold text-xl mb-4 transition-colors duration-300 ${
              isHovered ? "text-gray-700" : "text-gray-800"
            }`}
          >
            {service.title}
          </h3>
